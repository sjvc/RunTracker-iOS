    ...
    override func viewDidLoad() {
        ...
        tableContents = [
            RadioSection(title: "Selecciona intervalo de notificación", options: [
                ...
                OptionRow(text: "1 minuto", isSelected: type == IntervalType.TIME && value == 1 * 60, icon: .image(timeImage!), action: didToggleSelection(IntervalType.TIME, 1 * 60)),
                OptionRow(text: "5 minutos", isSelected: type == IntervalType.TIME && value == 5 * 60, icon: .image(timeImage!), action: didToggleSelection(IntervalType.TIME, 5 * 60)),
                OptionRow(text: "10 minutos", isSelected: type == IntervalType.TIME && value == 10 * 60, icon: .image(timeImage!), action: didToggleSelection(IntervalType.TIME, 10 * 60)),
                OptionRow(text: "15 minutos", isSelected: type == IntervalType.TIME && value == 15 * 60, icon: .image(timeImage!), action: didToggleSelection(IntervalType.TIME, 15 * 60)),
                OptionRow(text: "30 minutos", isSelected: type == IntervalType.TIME && value == 30 * 60, icon: .image(timeImage!), action: didToggleSelection(IntervalType.TIME, 30 * 60)),
                OptionRow(text: "45 minutos", isSelected: type == IntervalType.TIME && value == 45 * 60, icon: .image(timeImage!), action: didToggleSelection(IntervalType.TIME, 45 * 60)),
                OptionRow(text: "60 minutos", isSelected: type == IntervalType.TIME && value == 60 * 60, icon: .image(timeImage!), action: didToggleSelection(IntervalType.TIME, 60 * 60)),
